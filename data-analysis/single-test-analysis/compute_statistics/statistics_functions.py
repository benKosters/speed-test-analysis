...
def find_test_duration(data):
    """
    Compute the duration between bytecount events using the first and last bytecount events
    """
...
def calculate_percent_of_all_flows_contributing(byte_count, max_flows):
    ...
    This function is a derivation of calculate_occurance_sums above
